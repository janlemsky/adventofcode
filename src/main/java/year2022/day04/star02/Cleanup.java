...
public class Cleanup {
    ...
    public static void main(String[] args) {
        ...
        for (String pair : pairs) {
            ...
            if (
                    (firstElfSecondSection >= secondElfFirstSection && firstElfSecondSection <= secondElfSecondSection) ||
                    (secondElfSecondSection >= firstElfSecondSection && secondElfSecondSection <= firstElfSecondSection) ||
                    (firstElfFirstSection >= secondElfFirstSection && firstElfFirstSection <= secondElfSecondSection) ||
