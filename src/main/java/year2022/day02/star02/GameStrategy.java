...
public class GameStrategy {
    ...
    public static void main(String[] args) {
        ...
        for(String round : rounds) {
            ...
            switch(enemyShape) {
                case "A":
                    if(myShape.equals("X")) totalScore += 3;
                    if(myShape.equals("Y")) totalScore += 1 + 3;
                    if(myShape.equals("Z")) totalScore += 2 + 6;
                    break;
                case "B":
                    ...
                    break;
                case "C":
                    if(myShape.equals("X")) totalScore += 2;
                    if(myShape.equals("Y")) totalScore += 3 + 3;
                    if(myShape.equals("Z")) totalScore += 1 + 6;
                    break;
            }
        }
